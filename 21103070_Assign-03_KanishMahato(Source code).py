...
if arr_3.__len__() == 1:   # checking if it is single word
    arr_2 = arr_2.upper()# making upper case for same letter
    arr_2 = arr_2.replace(" ", "")# deleting spaces
...
print("Enter the value for squaring")
...
try:
    ...
    while True:
        ...
        print("IF you not want to enter value then enter any character for printing list")
# if the input is not-integer it print the list
except:
    print("printting original list")
    print(my_list)
...
myresult = [(num, pow(num, 2)) for num in my_list]
...
def point():
    marks = int(input("Enter Grade Point: \n"))
...
print("c) part:----")
c_partset = ((Set1 & Set2) | (Set2 & Set3) |
             (Set3 & Set1)-(Set1 & Set2 & Set3))
print(c_partset)
# d) part:----
