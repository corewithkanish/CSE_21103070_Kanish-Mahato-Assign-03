...
grade = math.floor(marks)  # changing float value into integer if enter by user
...
# making new string
lost = 'ABCDEFGHIJK'
# slicing two character from last
lost2 = lost.replace('JK', '')
# printing  the sliced character
print(lost2)
# slicing two character from last
lost3 = lost2.replace('HI', '')
# printing  the sliced character
print(lost3)
# slicing two character from last
lost4 = lost3.replace('FG', '')
# printing  the sliced character
print(lost4)
# slicing two character from last
lost5 = lost4.replace('DE', '')
# printing  the sliced character
print(lost5)
# slicing two character from last
lost6 = lost5.replace('BC', '')
# printing  the sliced character
print(lost6)
...
print("Fobonacci sequence given below")
...
if num_1 <= 0:
    ...
    print("Error : Invalid no. try again ")
else:
